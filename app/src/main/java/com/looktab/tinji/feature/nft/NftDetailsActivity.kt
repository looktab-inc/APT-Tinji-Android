...
//import com.looktab.tinji.feature.WebActivity
...
//    private lateinit var nftShop: TextView
//
...
//        nftShop = findViewById(R.id.nftShop)
//        btnBack = findViewById(R.id.btnBack)
//
//        nftShop.setOnClickListener {
//            val intent = Intent(this@NftDetailsActivity, WebActivity::class.java)
...
//                        NftAttributesRecyclerViewAdapter(it.attributes!!.toTypedArray())
//
...
//                    val royaltyFeeBasis =
//                        (nft.metadataAccount.data.sellerFeeBasisPoints.toDouble() / 100).toString()
//                    val metadataStatus =
//                        if (nft.metadataAccount.isMutable) "Mutable" else "Immutable"
//                    val nftOverviewProps =
//                        arrayOf<String>(salesStatus, royaltyFeeBasis.plus("%"), metadataStatus)
//                    updateAllTextViews(findViewById(R.id.nftOverview), nftOverviewProps)
//
//                    index = -1
//
//                    val nftSummaryProps = arrayOf<String>(
//                        nft.metadataAccount.update_authority.toBase58(),
//                        nft.metadataAccount.mint.toBase58(),
...
//    }
//
//    private fun makeCreatorsViews(
//        view: ViewGroup,
//        hasCreators: Boolean,
//        creators: Array<MetaplexCreator>
//    ) {
//        if (hasCreators) {
